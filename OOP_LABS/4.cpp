...
// 11
	sterling inputsterling(sterling a);
	sterling count(sterling a,sterling b,sterling sum);
...
int main()
{
	...
	while (End)
	{
		...
		{
			timee t1;
			cout << "введите 2 числа: минуты и секунды. И мы их поменяем местами!" << endl;
			cin >> t1.minutes >> t1.seconds;
			swap(t1.minutes, t1.seconds);
			cout << t1.minutes<< " " << t1.seconds << endl;
			break;
